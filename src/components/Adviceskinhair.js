  ...
  return (
    <div className='skinhair-container'>
        ...
        <div className='skinhair-wrapper'>
          ...
          <br/>
          Reeglina on teie lemmikloomade meelest pesupäeva näol tegemist kõrgema kategooria ahistamisega, mis teeb nende liiga sagedase kümblemise üpris problemaatiliseks. Loomade pesemise puhul võikski lähtuda põhimõttest – nii tihti kui vajalik, nii harva kui võimalik.</p>
        </div>
    </div>
  )
}

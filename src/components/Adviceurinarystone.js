  ...
  return (
    <div>
        ...
        <div className='wrapper'>
          ...
          <h4>Halloo! Kas loomaarst kuuleb? Kuulge, mu kass on kõhust kinni. Istub kasti peal ja mitte midagi ei tule.</h4>
          <p>Tavaliselt ei ole teie kass mitte kõhust kinni vaid teda on tabanud nõndanimetatud kasside tsivilisatsioonihaigus – alumiste kuseteede haigestumine e. kasside kuseteede sündroom (inglise keeles kasutatakse lühendit FUS – Feline Urinary Syndrom), mis hõlmab enda alla terve rea kodukassidel esinevaid erinevate tekkepõhjustega alumiste kuseteede haigusi. Statistilistel andmetel on loomakliinikutesse vastuvõtule tulevatest kassidest 9,6 % selline haigussündroom. See sündroom on tõsiseks katsumuseks nii loomaarstidele kui ka loomaomanikele ning tublisti vaevavaks kassidele enestele.
            <br/>
          ...
          <ul className='nutrition-list'>
            <h5>Nüüd tahaksite kindlasti teada, kuidas siis oma kassikest õigesti toita? Kindlaid juhiseid on kõigile korraga väga raske anda, kuid mõned lihtsamad kuldreeglid oleksid:</h5>
            <li>kvaliteetne (parem kui teie oma loomaarsti soovitatud) kuivtoit olgu kassile pidevalt saadaval</li>
            <li>ärge vahetage tihti toidusarju vaid püüdke jääda truuks ühele toidule</li>
            <li>konservidega toites on oht väiksem (kuid on olemas ka madalakvaliteedilise konserve, mille kohta see reegel ei kehti)</li>
            <li>valige rasvarikkam toit (rasv olgu loomne)</li>
            <li>mida odavam toit, seda vähem on temas liha ja rohkem teravilja ning seda aluselisem on uriin</li>
            <li>värske joogivesi olgu alati vabalt saadaval (kui kass siiski joob vähe, siis eelistage konserve)</li>
            <li>Jälgige kuivtoidu pakendil märgitut ja vaadake, kas sellele on lisatud happesust reguleerivaid aineid ammoniumkloriidi ja DL-metioniini, sest need hoiavad uriini pH vajalikul tasemel.</li>
          </ul>
          <p>Arenenumad riigid, kus veterinaardietoloogia on kõrgemal tasemel, maadeldakse kasside kuseteede haiguste vallas juba uute probleemidega. Hapustavate ainete lisamisega toitudele saavutatakse kõrvalefekt, kus uriini happesus muutub liialt suureks ja hakkavad tekkima kusekivid mida medikamentide ja dieediga lahustada ei saa. Need kusekivid on kaltsium oksalaadid. Happeline uriin lahustab struviite, kuid soodustab oksalaat-kivide moodustumist.</p>
        </div>
    </div>
  )
}

export default Adviceurinarystone
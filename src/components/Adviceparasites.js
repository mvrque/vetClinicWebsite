  ...
  return (
    <div>
        ...
        <div className='parasites-wrapper'>
          ...
          <div><p>Sageli jäävad kirbud teie lemmikute karvades märkamatuks. Seda eriti kui koera/kassi kasukas on tumedat värvi. Kui teie koer või kass ennast kratsib ja kõhvitseb ning teil on alust kahtlustada kirbu olemasolu, siis oma kahtluste kinnituseks või ümberlükkamiseks tehke väike katse. Võtke kamm, poorne lumivalge paber ja veepihusti. Paberiks sobiks kõige paremini filter- või kuivatuspaber, mis hästi vett imaks ja veepihustiks triikimisprits. Asetage koer/kass paberi kohale ja kammige teda. Kammimise käigus pudenevad paberile tolm ja karvades olev mustus. Seejärel pritsige paber ja sellel olevad kübemed märjaks.
          Kui märkate, et osade mustuseterakeste ümber ilmuvad pruunikad laialivalguvad viirud, siis on tegemist kirbu väljaheidetega ja teie lemmikul on kirp (kirbud).</p>
          </div>
